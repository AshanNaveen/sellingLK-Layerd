...
public class SearchFormController {
    ...
    private SearchBO searchBO = (SearchBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.SEARCH);
    ...
    void btnSearchOnAction(ActionEvent event) {
        ...
        if (!tglWeb.isSelected()) {
            ...
            try {
                List<VehicleDto> result = searchBO.search(serchDto);
            ...
            try {
                boolean isSaved=searchBO.save(webVehicleDtos);
                if (isSaved) {
    ...
    void generateExcel(){
        try
        {
            ...
            List<WebVehicleDto> list=searchBO.getAllSearch();
