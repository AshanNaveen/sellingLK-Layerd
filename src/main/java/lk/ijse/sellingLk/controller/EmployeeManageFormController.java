...
public class EmployeeManageFormController {
    ...
    void btnSaveOnAction(ActionEvent event) {
        ...
        try {
            String id = employeeBO.getNextEmpId();
            String uId = employeeBO.getUserId(SignInFormController.uname, SignInFormController.pword);
            System.out.println(uId);
            if (employeeBO.saveEmployee(new EmployeeDto(
                    id,
                    name,
                    email,
                    address,
