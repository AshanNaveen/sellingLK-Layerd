...
import lk.ijse.sellingLk.bo.custom.impl.SellerBOImpl;
...
public class SellerBarController {
    ...
    private SellerBO sellerBO = new SellerBOImpl();
    ...
    void btnDeleteOnAction(ActionEvent event) {
        try {
            ...
            if (alert.getResult()==ButtonType.YES){
                if (sellerBO.deleteSeller(txtId.getText())){
    ...
    void btnUpdateSaveOnAction(ActionEvent event) {
        ...
        try {
            if(sellerBO.updateSeller(new SellerDto(
                    txtId.getText(),
                    txtName.getText(),
                    txtNic.getText(),
                    txtEmail.getText(),
                    txtAddress.getText(),
                    txtContact.getText(),
                    sellerBO.getUserId(SignInFormController.uname,SignInFormController.pword)
