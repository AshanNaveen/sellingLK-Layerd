...
import lk.ijse.sellingLk.bo.custom.impl.PreOrderBOImpl;
...
public class PreOrderbarController {
    ...
    private PreOrderBO preOrderBO = new PreOrderBOImpl();
    ...
    void btnDeleteOnAction(ActionEvent event) {
        try {
            ...
            if (alert.getResult() == ButtonType.YES) {
                if (preOrderBO.deletePreOrder(txtId.getText())) {
    ...
    void btnEditOnAction(ActionEvent event) {
        String phone = null;
        try {
            phone = preOrderBO.getBuyerPhone(txtBuyerName.getText());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    void btnUpdateOnAction(ActionEvent event) {
        String name = null;
        try {
            name = preOrderBO.getBuyerName(txtEContact.getText());
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    public void setData(PreOrderDto dto) {
        String name = null;
        try {
            name = preOrderBO.getBuyerName(dto.getBuyerId());
        } catch (SQLException e) {
            e.printStackTrace();
        }
