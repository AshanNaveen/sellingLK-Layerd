...
import lk.ijse.sellingLk.bo.custom.impl.EmployeeBOImpl;
...
public class EmployeeBarController {
    ...
    void btnDeleteOnAction(ActionEvent event) {
        try {
            ...
            if (alert.getResult()==ButtonType.YES){
                if (employeeBO.deleteEmployee(txtEmpCode.getText())){
    ...
    void btnUpdateOnAction(ActionEvent event) {
        ...
        try {
            if(employeeBO.updateEmployee(new EmployeeDto(
                    txtEmpCode.getText(),
                    txtName.getText(),
                    txtEmail.getText(),
                    txtAddress.getText(),
                    txtPhone.getText(),
                    txtRole.getText(),
                    employeeBO.getUserId(SignInFormController.uname,SignInFormController.pword)
